...
export class MembershipComponent implements OnInit {
  ...
  public deleteUser(user:User){
    ...
    if(!this.loginService.hasPermission('delete_user')){
      this.toastrService.warning("Você não possui a permissão para excluir usuários!");
      return;
    }
  ...
  public openModal(modalContent, user) {
    ...
    if(!this.loginService.hasPermission('edit_user')){
      this.toastrService.warning("Você não possui a permissão para editar usuários!");
      return;
    }
